    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(help_text='Enter a valid Iranian phone number (e.g., +989123456789).', max_length=15, unique=True, validators=[django.core.validators.RegexValidator(code='invalid_phone', message='Enter a valid Iranian phone number (e.g., +989123456789).', regex='^\\+98(9\\d{9})$')])),
